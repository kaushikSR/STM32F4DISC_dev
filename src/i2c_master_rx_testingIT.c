...
int main(void)
{
	...
	I2C_IRQInterruptConfig(I2C1_EV,ENABLE);
	I2C_IRQInterruptConfig(I2C1_ER,ENABLE);
	...
	while(1)
	{
		...
		while(I2C_MasterSendDataIT(&I2C1Handle,&commandcode,1,SLAVE_ADDR,ENABLE) != I2C_READY);

		while(I2C_MasterReceiveDataIT(&I2C1Handle,&len,1,SLAVE_ADDR,ENABLE)!= I2C_READY);
		...
		while(I2C_MasterReceiveDataIT(&I2C1Handle,rcv_buf,len,SLAVE_ADDR,DISABLE)!= I2C_READY);
...
// Interrupt service routine for I2C events
void I2C1_EV_IRQHandler (void)
{
	I2C_EV_IRQHandling(&I2C1Handle);
}

// Interrupt service routine for I2C errors
...
void I2C_ApplicationEventCallback(I2C_Handle_t *pI2CHandle,uint8_t AppEv)
{
     ...
     }else if (AppEv == I2C_ERROR_AF)
     {
    	 ...
    	 //Hang in infinite loop if code fails in between
    	 while(1);
     }
}
