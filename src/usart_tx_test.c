...
void 	USART2_GPIOInit(void)
{
	...
	usart_gpios.GPIO_PinConfig.GPIO_PinSpeed = GPIO_OP_SPEED_HIGH;
	usart_gpios.GPIO_PinConfig.GPIO_PinAltFunMode = AF7;

	//USART2 TX
	usart_gpios.GPIO_PinConfig.GPIO_PinNumber  = GPIO_PIN2;
	GPIO_Init(&usart_gpios);

	//USART2 RX
	usart_gpios.GPIO_PinConfig.GPIO_PinNumber = GPIO_PIN3;
	GPIO_Init(&usart_gpios);
